...
target_classes = ["car", "bus", "truck" , "bicycle"]

output_directory = "./Running_YOLOv8_Webcam/detection_distance_object/output_detected_vehicle"
...
while True:
    ...
    cv2.putText(img, f'Target Vehicles : {bounding_box_count}', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
